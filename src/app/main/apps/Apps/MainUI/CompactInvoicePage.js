...
const useStyles = makeStyles(theme => ({
	...
	button: {
		background: "linear-gradient(to right, #335BFF 0%, #122330 100%)",
...
function CompactInvoicePage() {
	...
	return (
		<div className={clsx(classes.root, 'flex-grow flex-shrink-0 p-0 sm:p-32 print:p-0')}>
			{invoice && (
				<FuseAnimate animation={{ translateY: [0, '100%'] }} duration={600}>
					<Card className="mx-auto w-full print:w-full print:p-8 print:shadow-none ">
				...
				<div  id="printJS-form">
							...
							<div className="flex justify-between">
								...
								<div className={clsx(classes.seller, 'flex items-center p-16')}>
									...
									<div className={clsx(classes.divider, 'w-px mx-8 h-36 opacity-50')} />
 ...
 <div className="page-break-before"></div>
						...
						onClick={print({ printable: 'printJS-form', type: 'html'})}
						 variant="outlined">
       Print
      </Button>
